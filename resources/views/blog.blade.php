    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary">Read Mode</a>
            </div>
        </div>
        ...
        <div class="row">
            @foreach ($posts->skip(1) as $post)
                <div class="col-4 mb-3">
                    <div class="card">
                        <div class="position-absolute text-white py-2 px-3" style="background-color: rgba(0, 0, 0, 0.7)">
